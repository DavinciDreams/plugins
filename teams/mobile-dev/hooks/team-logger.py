#!/usr/bin/env python3
"""Mobile dev team telemetry logger - appends tool usage events to JSONL.

Reads PostToolUse hook data from stdin, writes structured events to:
  ~/.claude/team-logs/mobile-dev.jsonl

Each line is a JSON object:
  {"ts": "ISO8601", "tool": "Write", "file": "src/App.tsx", "team": "mobile-dev", "status": "ok"}
"""
